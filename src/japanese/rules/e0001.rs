...
impl DiagnosticRule for E0001 {
    ...
    fn general_explanation(&self) -> JapaneseDiagnostic {
        let mut jd = JapaneseDiagnostic::new(
            ...
            "error",
            self.title(),
            "This error suggests that the expression arm corresponding to the noted pattern will never be reached as for all possible values of the expression being",
