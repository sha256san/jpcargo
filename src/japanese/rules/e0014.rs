...
impl DiagnosticRule for E0014 {
    ...
    fn general_explanation(&self) -> JapaneseDiagnostic {
        let mut jd = JapaneseDiagnostic::new(
            ...
            "error",
            self.title(),
            "Constants can only be initialized by a constant value or, in a future version of Rust, a call to a const function. This error indicates the use",
