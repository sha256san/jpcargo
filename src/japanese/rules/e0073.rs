...
impl DiagnosticRule for E0073 {
    ...
    fn general_explanation(&self) -> JapaneseDiagnostic {
        let mut jd = JapaneseDiagnostic::new(
            ...
            "error",
            self.title(),
            "You cannot define a struct (or enum) Foo that requires an instance of Foo in order to make a new Foo value. This is because there would be no way a",
